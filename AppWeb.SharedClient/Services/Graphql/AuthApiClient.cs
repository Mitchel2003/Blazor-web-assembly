...
namespace AppWeb.SharedClient.Services.Graphql;
    ...
    public async Task<LoginResultDto?> LoginAsync(LoginInput input, CancellationToken cancellationToken = default)
    {
        ...
        { //verify status code and process errors
            ...
            try
            {
                ...
                throw new ApiException(response.StatusCode, errors); // throw ApiException with status code and error messages
            }
