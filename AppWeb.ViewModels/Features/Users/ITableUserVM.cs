...
public interface ITableUserVM : IDisposable
{
    ...
    HashSet<UserResultDto> SelectedItems { get; }
    ...
    /// <summary>Event raised when a user add action is requested.</summary>
    event EventHandler OnAdd;

    /// <summary>Event raised when a user edit action is requested.</summary>
    event EventHandler<UserResultDto> OnEdit;

    /// <summary>Event raised when a user delete action is requested.</summary>
    event EventHandler<UserResultDto> OnDelete;

    /// <summary>Event raised when a user view action is requested.</summary>
